{
  ...
  inputs = {
    ...
    bspwm-desktops-report = {
      url = "path:./home/raw/eww/scripts/bspwm-desktops-report";
      inputs.nixpkgs.follows = "nixpkgs";
    };
    window-title-watcher = {
      url = "path:./home/raw/eww/scripts/window-title-watcher";
      inputs.nixpkgs.follows = "nixpkgs";
    };
    eww-bar-selector = {
      url = "path:./scripts/eww-bar-selector";
      inputs.nixpkgs.follows = "nixpkgs";
    };
    volume-watcher = {
      url = "path:./home/raw/eww/scripts/volume-watcher";
      inputs.nixpkgs.follows = "nixpkgs";
    };
  };
